...
import static ua.com.foxminded.university.TestObjects.ID3;
...
//    }
    ...
    class GetAllByFacultyIdTest {
        ...
        void testGetAllDepartmentsByFacultyId1() {
            ...
            List<Department> departmentsFromFaculty1 = dao.findAllByFacultyId(ID1);
        ...
        void testGetAllDepartmentsByFacultyId3() {
            assertThat(dao.findAllByFacultyId(ID3)).isEmpty();
        }
    }
}