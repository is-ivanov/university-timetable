...
//
//            List<Student> studentsByLesson1 = dao.findAllByLesson(lesson);
...
//    }
    ...
    class GetStudentsByGroupTest {
        ...
        void testGetStudentsByGroup() {
            ...
            List<Student> studentsByGroup = dao.findAllByGroup(group);
    ...
    class GetStudentsByFacultyTest {
        ...
        void testGetByFacultyId1_ReturnTwoStudents() {
            ...
            List<Student> studentsByFaculty = dao.findAllByFaculty(faculty);
        ...
        void testGetByFacultyId4_ReturnEmptyList() {
            ...
            List<Student> actualStudents = dao.findAllByFaculty(faculty);
