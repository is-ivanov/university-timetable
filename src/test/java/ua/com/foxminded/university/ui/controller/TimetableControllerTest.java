...
class TimetableControllerTest {
    ...
    class ShowStudentTimetableTest {
        ...
        void getRequestWithPathVariableIdShouldCallServicesAndReturnTemplate()
            throws Exception {
            int studentId = 23;

            Student student = createTestStudent();

            when(studentServiceMock.findById(studentId)).thenReturn(student);
            ...
            mockMvc.perform(get(URI_TIMETABLE_STUDENT, studentId))
                ...
                .andExpectAll(
                    ...
                    model().attribute("object", student)
                );
        }
    }
    ...
    class ShowTeacherTimetableTest {
        ...
        void getRequestWithPathVariableIdShouldCallServicesAndReturnTemplate()
            ...
            when(teacherServiceMock.findById(teacherId)).thenReturn(teacher);
            ...
            mockMvc.perform(get(URI_TIMETABLE_TEACHER, teacherId))
                ...
                .andExpectAll(
                    ...
                    model().attribute("object", teacher)
                );
        }
    }
