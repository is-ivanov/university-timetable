...
class ResponseUtilTest {
    ...
    class TestDefineRedirect {
        ...
        void defineRedirectStringInput() {
            assertThat(ResponseUtil.defineRedirect(URI), is(equalTo(EXPECTED_REDIRECT_STRING)));
        }
        ...
        void defineRedirectHttpServletRequestInput() {
            ...
            assertThat(ResponseUtil.defineRedirect(request), is(equalTo(EXPECTED_REDIRECT_STRING)));
        }
    }
